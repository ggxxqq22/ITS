...
function adaptor(params) {
    ...
    return utils_1.flow(geometry, meta, common_1.theme, coordinate, common_1.legend, function (args) { return common_1.tooltip(adaptorTooltipOptions(args)); }, label, common_1.state, common_1.annotation(), 
    /** 指标卡中心文本 放在下层 */
