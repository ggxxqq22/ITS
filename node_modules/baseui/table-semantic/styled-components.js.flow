...
export const StyledTable = styled<StyledTablePropsT>('table', ({
  $theme,
  $width
}) => {
  return {
...
export const StyledTableHeadCellSortable = withStyle<typeof StyledTableHeadCell, {}>(StyledTableHeadCell, ({
  $theme
}) => {
  return {
    cursor: 'pointer',
...
export const StyledSortAscIcon = styled<typeof ChevronDown, {}>(ChevronDown, ({
  $theme
}) => {
  return {
    position: 'absolute',
...
export const StyledSortDescIcon = styled<typeof ChevronUp, {}>(ChevronUp, ({
  $theme
}) => {
  return {
    position: 'absolute',
...
export const StyledSortNoneIcon = styled<typeof Blank, {}>(Blank, ({
  $theme
}) => {
  return {
    position: 'absolute',
...
export const StyledTableBodyCell = styled<StyledTableBodyCellPropsT>('td', ({
  $theme,
  $isNumeric
}) => {
