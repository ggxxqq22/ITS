...
class Select extends React.Component<PropsT, SelectStateT> {
  ...
  constructor(props: PropsT) {
    ...
    _defineProperty(this, "handleTouchOutside", (event: TouchEvent) => {
    ...
    _defineProperty(this, "handleTouchEnd", (event: TouchEvent) => {
      if (this.dragging) return;
      this.handleClick(event);
    });
    _defineProperty(this, "handleTouchEndClearValue", (event: TouchEvent) => {
      if (this.dragging) return;
      this.clearValue(event);
    });
    _defineProperty(this, "handleClick", (event: MouseEvent | TouchEvent) => {
    ...
    _defineProperty(this, "handleInputFocus", (event: SyntheticEvent<HTMLElement>) => {
    ...
    _defineProperty(this, "handleBlur", (event: Event) => {
      if (containsNode(this.anchor.current, event.target)) {
        return;
      }
    ...
    _defineProperty(this, "handleClickOutside", (event: MouseEvent) => {
    ...
    _defineProperty(this, "handleInputChange", (event: SyntheticInputEvent<HTMLInputElement>) => {
    ...
    _defineProperty(this, "handleKeyDown", (event: KeyboardEvent) => {
      if (this.props.disabled) return;
    ...
    _defineProperty(this, "getOptionLabel", (locale: LocaleT, {
      option
    }: {
      option: OptionT,
      optionState: {
    ...
    }): React.Node => option.isCreatable ? `${locale.select.create} “${option[this.props.labelKey]}”` : option[this.props.labelKey]);
    ...
    _defineProperty(this, "addValue", (item: OptionT) => {
      const valueArray = [...this.props.value];
    ...
    _defineProperty(this, "removeValue", (item: OptionT) => {
      const valueArray = [...this.props.value];
      this.setValue(valueArray.filter(i => i[this.props.valueKey] !== item[this.props.valueKey]), item, STATE_CHANGE_TYPE.remove);
      this.focus();
    });
    _defineProperty(this, "clearValue", (event: KeyboardEvent | MouseEvent | TouchEvent) => {
  ...
  renderValue(valueArray: ValueT, isOpen: boolean, locale: LocaleT): ?React.Node | Array<?React.Node> {
    const {
      overrides = {}
    } = this.props;
    const sharedProps = this.getSharedProps();
