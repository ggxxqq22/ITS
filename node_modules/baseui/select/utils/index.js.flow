...
*/
// @flow
import type { PropsT, OptionT, OptionsT, OptgroupsT, ValueT, SelectStateT } from '../types.js';
...
export const shouldShowPlaceholder = (state: SelectStateT, props: $Shape<PropsT>, isOpen: boolean) => {
  const {
    inputValue,
    isPseudoFocused,
    isFocused
