...
export const StyledStep = styled<StylePropsT>('li', ({
  $theme
}) => {
  return {
    listStyleType: 'none',
...
export const StyledIcon = styled<StylePropsT>('div', ({
  $theme,
  $isActive,
  $isCompleted,
  $disabled
...
export const StyledInnerIcon = styled<StylePropsT>('div', ({
  $theme
}) => {
  return {
...
export const StyledContent = styled<StylePropsT>('div', ({
  $theme
}) => {
...
export const StyledContentTitle = styled<StylePropsT>('div', ({
  $theme,
  $isActive
}) => {
...
export const StyledContentTail = styled<StylePropsT>('div', ({
  $theme,
  $isCompleted,
  $isActive
}) => {
...
export const StyledContentDescription = styled<StylePropsT>('div', ({
  $theme
}) => {
  return {
...
export const StyledNumberStep = styled<StylePropsT>('li', ({
  $theme
}) => {
  return {
    listStyleType: 'none',
...
export const StyledNumberIcon = styled<StylePropsT>('div', ({
  $theme,
  $isActive,
  $isCompleted,
  $disabled
...
export const StyledNumberContentTail = styled<StylePropsT>('div', ({
  $theme,
  $isActive,
  $isCompleted,
  $disabled
