...
export const StyledRoot = styled<StyledRootPropsT>('ul', ({
  $theme
}) => {
  return {
    marginLeft: 0,
...
export const StyledStar = styled<StyledRatingItemPropsT>('li', ({
  $theme,
  $isActive,
  $isSelected,
  $isFocusVisible
...
export const StyledEmoticon = styled<StyledRatingItemPropsT>('li', ({
  $theme,
  $isActive,
  $isSelected,
  $index = 1,
