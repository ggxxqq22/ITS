...
class Button extends React.Component< // eslint-disable-next-line flowtype/no-weak-types
ButtonPropsT & {
  forwardedRef: any
}, {
...
const ForwardedButton = React.forwardRef<ButtonPropsT, HTMLButtonElement>((props: ButtonPropsT, ref) => React.createElement(Button, _extends({
  forwardedRef: ref
}, props)));
