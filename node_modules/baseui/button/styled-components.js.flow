...
export const BaseButton = styled<SharedStylePropsT>('button', ({
  $theme,
  $size,
  $kind,
  $shape,
...
export const EndEnhancer = styled<SharedStylePropsT>('div', ({
  $theme
}) => {
...
export const StartEnhancer = styled<SharedStylePropsT>('div', ({
  $theme
}) => {
...
export const LoadingSpinner = styled<SharedStylePropsT>('span', ({
  $theme,
  $kind,
  $disabled,
  $size
