...
const FlexGridItemComponent = React.forwardRef<FlexGridItemPropsT, HTMLElement>((props: FlexGridItemPropsT, ref) => React.createElement(FlexGridItem, _extends({}, props, {
  forwardedRef: ref
})));
