...
const FlexGrid = ({
  ...
  flattenFragments(children).map((child: React.Node, flexGridItemIndex: number, {
...
const FlexGridComponent = React.forwardRef<FlexGridPropsT, HTMLElement>((props: FlexGridPropsT, ref) => React.createElement(FlexGrid, _extends({}, props, {
  forwardedRef: ref
})));
