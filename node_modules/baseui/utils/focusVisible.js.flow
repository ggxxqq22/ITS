...
export const forkFocus = (rootProps: any, handler: ((e: SyntheticEvent<>) => void)) => (e: SyntheticEvent<>) => {
  if (typeof rootProps.onFocus === 'function') {
    rootProps.onFocus(e);
  }
  handler(e);
};
export const forkBlur = (rootProps: any, handler: ((e: SyntheticEvent<>) => void)) => (e: SyntheticEvent<>) => {
