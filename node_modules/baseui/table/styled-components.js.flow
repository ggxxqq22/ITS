...
const StyledHeadElement = styled<HorizontalStyleProps>('div', ({
  $theme,
  $width
}) => {
  return {
...
export const StyledHead = ((React.forwardRef<HorizontalStyleProps, any>((props, ref) => React.createElement(StyledHeadElement, _extends({
  ref: ref,
  role: "row"
}, props)) // eslint-disable-next-line flowtype/no-weak-types
...
const StyledHeadCellElement = styled<HorizontalStyleProps>('div', ({
  $theme,
  $cursor
}) => {
...
export const StyledHeadCell = ((React.forwardRef<{}, any>((props, ref) => React.createElement(StyledHeadCellElement, _extends({
  ref: ref,
  role: "columnheader"
}, props)) // eslint-disable-next-line flowtype/no-weak-types
): any): StyletronComponent<{}>);
...
const StyledBodyElement = styled<HorizontalStyleProps>('div', ({
  $width
}) => {
  return ({
    width: $width ? $width : '100%',
...
export const StyledBody = ((React.forwardRef<HorizontalStyleProps, any>((props, ref) => React.createElement(StyledBodyElement, _extends({
  ref: ref,
  role: "rowgroup"
}, props)) // eslint-disable-next-line flowtype/no-weak-types
): any): StyletronComponent<HorizontalStyleProps>);
...
export const StyledRow = ((React.forwardRef<{}, any>((props, ref) => React.createElement(StyledRowElement, _extends({
  ref: ref,
  role: "row"
}, props)) // eslint-disable-next-line flowtype/no-weak-types
): any): StyletronComponent<{}>);
...
const StyledCellElement = styled<CellStyledProps>('div', ({
  $theme,
  $striped
}) => {
...
export const StyledCell = ((React.forwardRef<CellStyledProps, any>((props, ref) => React.createElement(StyledCellElement, _extends({
  ref: ref,
  role: "gridcell"
}, props)) // eslint-disable-next-line flowtype/no-weak-types
