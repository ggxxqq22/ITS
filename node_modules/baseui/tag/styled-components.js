...
var Action = (0, _index.styled)('span', function (props) {
  ...
  return _ref = {
    ...
    boxShadow: props.$isFocusVisible ? "0 0 0 3px ".concat( // when tag has the same background as focus-ring, we need to pick a different color
    props.$kind === _constants.KIND.accent ? $theme.colors.primaryA : $theme.colors.accent) : 'none'
  }), _ref;
});
