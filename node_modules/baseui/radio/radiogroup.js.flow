...
class StatelessRadioGroup extends React.Component<PropsT, StatelessStateT> {
  constructor(...args) {
    ...
    _defineProperty(this, "handleFocus", (event: SyntheticInputEvent<HTMLInputElement>, index: number) => {
    ...
    _defineProperty(this, "handleBlur", (event: SyntheticInputEvent<HTMLInputElement>, index: number) => {
