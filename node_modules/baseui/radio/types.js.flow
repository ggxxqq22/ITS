...
export type OverridesT = { ...$Exact<RadioOverridesT>,
...
export type StateReducerT = (stateType: string, nextState: StateT, currentState: StateT, event: SyntheticInputEvent<HTMLInputElement>) => StateT;
