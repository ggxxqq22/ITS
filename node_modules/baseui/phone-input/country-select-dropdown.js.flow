...
function CountrySelectDropdown(props: CountrySelectDropdownPropsT & {
  ...
  if (!props.children.length) {
    return React.createElement(LocaleContext.Consumer, null, (locale: LocaleT) => React.createElement(EmptyState, emptyStateProps, noResultsMsg || locale.menu.noResultsMsg));
  }
...
export default React.forwardRef<CountrySelectDropdownPropsT, typeof CountrySelectDropdown>((props, ref) => React.createElement(CountrySelectDropdown, _extends({}, props, {
  $forwardedRef: ref
})));