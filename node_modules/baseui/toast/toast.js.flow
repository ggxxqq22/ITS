...
import type { ToastPropsT, ToastPropsShapeT, ToastPrivateStateT, SharedStylePropsArgT } from './types.js';
...
class Toast extends React.Component<ToastPropsT, ToastPrivateStateT> {
  constructor(props: ToastPropsT) {
    ...
    _defineProperty(this, "handleFocus", (event: SyntheticEvent<>) => {
    ...
    _defineProperty(this, "handleBlur", (event: SyntheticEvent<>) => {
    ...
    _defineProperty(this, "animateOut", (callback: () => mixed = () => {}) => {
      this.setState({
        isVisible: false
  ...
  render() {
    ...
    }), closeable ? React.createElement(DeleteIcon, _extends({
      role: "button",
      tabIndex: 0,
    ...
    })) : null, React.createElement(InnerContainer, _extends({}, sharedProps, innerContainerProps), typeof children === 'function' ? children({
