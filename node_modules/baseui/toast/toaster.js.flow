...
import type { ToasterPropsT, ToastPropsShapeT, ToasterContainerStateT, ToastPropsT } from './types.js';
let toasterRef: ?React.ElementRef<typeof ToasterContainer> = null;
export class ToasterContainer extends React.Component<$Shape<ToasterPropsT>, ToasterContainerStateT> {
  constructor(_props: ToasterPropsT) {
    super(_props);
    ...
    _defineProperty(this, "getToastProps", (props: ToastPropsT): ToastPropsT & {
      key: React.Key
    } => {
      const {
        autoFocus,
    ...
    _defineProperty(this, "show", (props: ToastPropsT = {}): React.Key => {
    ...
    _defineProperty(this, "update", (key: React.Key, props: ToastPropsT): void => {
      this.setState(({
        toasts
      }) => {
    ...
    _defineProperty(this, "dismiss", (key: React.Key) => {
    ...
    _defineProperty(this, "clear", (key?: React.Key) => {
      key === undefined ? this.clearAll() : this.dismiss(key);
    });
    _defineProperty(this, "internalOnClose", (key: React.Key) => {
    ...
    _defineProperty(this, "getOnCloseHandler", (key: React.Key, onClose: ?() => mixed) => {
      return () => {
        this.internalOnClose(key);
        typeof onClose === 'function' && onClose();
      };
    });
    _defineProperty(this, "renderToast", (toastProps: ToastPropsT & {
      key: React.Key
    }): React.Node => {
      const {
        onClose,
