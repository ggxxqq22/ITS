...
class BaseInput<T: EventTarget> extends React.Component<BaseInputPropsT<T>, InternalStateT> {
  constructor(...args) {
    super(...args);
    _defineProperty(this, "inputRef", this.props.inputRef || React.createRef<any>());
    ...
    _defineProperty(this, "onInputKeyDown", (e: KeyboardEvent) => {
    ...
    _defineProperty(this, "onFocus", (e: SyntheticFocusEvent<T>) => {
      this.setState({
        isFocused: true
      });
      this.props.onFocus(e);
    });
    _defineProperty(this, "onBlur", (e: SyntheticFocusEvent<T>) => {
      this.setState({
        isFocused: false
      });
      this.props.onBlur(e);
    });
    _defineProperty(this, "handleFocusForClear", (event: SyntheticEvent<>) => {
    ...
    _defineProperty(this, "handleBlurForClear", (event: SyntheticEvent<>) => {
