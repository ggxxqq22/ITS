...
export default class Pagination extends React.PureComponent<PaginationPropsT, {
  ...
  constructor(...args) {
    ...
    _defineProperty(this, "getMenuOptions", memoize((numPages: number) => {
      const menuOptions = [];
    ...
    _defineProperty(this, "onMenuItemSelect", (data: {
      value: $ReadOnlyArray<PageOptionT>
    }) => {
    ...
    _defineProperty(this, "onPrevClick", (event: SyntheticEvent<>) => {
      const {
        currentPage,
        onPageChange,
        onPrevClick
    ...
    _defineProperty(this, "onNextClick", (event: SyntheticEvent<>) => {
      const {
        currentPage,
        numPages,
        onPageChange,
    ...
    _defineProperty(this, "constructAriaWayfinderLabel", (locale: LocaleT, prefix: string) => {
      const {
        currentPage,
        numPages,
        labels
