...
export default class Day extends React.Component<DayPropsT, DayStateT> {
  constructor(...args) {
    ...
    _defineProperty(this, "onClick", (event: Event) => {
      const {
        date,
        disabled
      } = this.props;
    ...
    _defineProperty(this, "onMouseOver", (event: Event) => {
      this.setState({
        isHovered: true
      });
    ...
    _defineProperty(this, "onMouseLeave", (event: Event) => {
      this.setState({
        isHovered: false
      });
  ...
  render() {
    ...
    React.createElement(LocaleContext.Consumer, null, (locale: LocaleT) => React.createElement(Day, _extends({
      "data-state-code": getDayStateCode(sharedProps),
