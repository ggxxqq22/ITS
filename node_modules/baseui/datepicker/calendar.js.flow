...
export default class Calendar extends React.Component<CalendarPropsT, CalendarInternalState> {
  constructor(props: CalendarPropsT) {
    ...
    _defineProperty(this, "getDateInView", (): Date => {
      const {
        highlightedDate,
        value
      } = this.props;
    ...
    _defineProperty(this, "handleMonthChange", (date: Date) => {
    ...
    _defineProperty(this, "handleYearChange", (date: Date) => {
    ...
    _defineProperty(this, "renderCalendarHeader", (date: Date = this.state.date, order: number) => {
    ...
    _defineProperty(this, "handleArrowKey", (key: string) => {
      const {
    ...
    _defineProperty(this, "handleTabbing", (event: KeyboardEvent) => {
      if (typeof document !== 'undefined') {
        if (event.keyCode === 9) {
    ...
    _defineProperty(this, "handleTimeChange", (time: Date, index: number) => {
      const {
        onChange = params => {}
      } = this.props;
    ...
    _defineProperty(this, "renderTimeSelect", (value: ?Date, onChange: Function, label: string) => {
      const {
        overrides = {}
      } = this.props;
