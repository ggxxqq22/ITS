...
import type { AnchorPropsT, PopoverPropsT, PopoverPrivateStateT, SharedStylePropsArgT } from './types.js';
...
class Popover extends React.Component<PopoverPropsT, PopoverPrivateStateT> {
  constructor(...args) {
    ...
    _defineProperty(this, "onAnchorClick", (e: Event) => {
    ...
    _defineProperty(this, "onPopperUpdate", (normalizedOffsets: NormalizedOffsetsT, data: PopperDataObjectT) => {
    ...
    _defineProperty(this, "onDocumentClick", (evt: MouseEvent) => {
  ...
  getSharedProps(): $Diff<SharedStylePropsArgT, {
    children?: React.Node
  }> {
    const {
      isOpen,
    ...
    if (renderedContent) {
      if (mountedAndOpen) {
        rendered.push(React.createElement(Layer, {
          ...
          noFocusGuards: true // see popover-focus-loop.scenario.js for why hover cannot return focus
          ,
