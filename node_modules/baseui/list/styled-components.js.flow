...
import type { StyledContentPropsT, StyledArtworkContainerPropsT } from './types.js';
...
export const StyledContent = styled<StyledContentPropsT>('div', ({
  $mLeft,
  $sublist,
  $theme
}) => {
...
export const StyledArtworkContainer = styled<StyledArtworkContainerPropsT>('div', ({
  $artworkSize,
  $theme
}) => {
  let padding = null;
