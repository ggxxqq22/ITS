...
export type StateReducerT = (stateChangeType: StateChangeTypeT, nextState: StatefulTabsStateT, currentState: StatefulTabsStateT) => StatefulTabsStateT;
...
export type TabsPropsT = {
  ...
  renderAll?: boolean,
  overrides?: TabsOverridesT<$Diff<SharedStylePropsArgT, {
    $active?: ?boolean
  }>>,
};
export type StatefulTabsPropsT = $Diff<TabsPropsT, {
  activeKey: React.Key
}> & {
