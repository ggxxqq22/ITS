 ...
 * prop into account
 */
export const Body = styled<SharedStylePropsArgT>('div', props => ({ ...getBodyStyles(props),
...
export const Inner = styled<SharedStylePropsArgT>('div', props => ({ ...getInnerStyles(props),
  backgroundColor: props.$theme.colors.tooltipBackground,
...
export const Arrow = styled<SharedStylePropsArgT>('div', props => ({ ...getArrowStyles(props),
  backgroundColor: props.$theme.colors.tooltipBackground
}));