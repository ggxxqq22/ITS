...
const AspectRatioBoxComponent = React.forwardRef<AspectRatioBoxPropsT, HTMLElement>((props: AspectRatioBoxPropsT, ref) => React.createElement(AspectRatioBox, _extends({}, props, {
  forwardedRef: ref
})));
