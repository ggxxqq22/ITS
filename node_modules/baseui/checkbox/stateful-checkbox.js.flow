...
import type { PropsT, StatefulCheckboxPropsT } from './types.js'; // Styled elements
const StatefulCheckbox = function (props: StatefulCheckboxPropsT) {
  return React.createElement(StatefulContainer, props, (childrenProps: PropsT) => React.createElement(Checkbox, childrenProps, props.children));
};
