...
import type { ModalPropsT, ModalStateT, SharedStylePropsArgT, CloseSourceT, ElementRefT } from './types.js';
...
class Modal extends React.Component<ModalPropsT, ModalStateT> {
  constructor(...args) {
    ...
    _defineProperty(this, "onDialogContainerBackdropClick", (e: Event) => {
