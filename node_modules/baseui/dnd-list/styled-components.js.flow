 ...
 */
export const Root = styled<SharedStylePropsArgT>('div', ({
  $theme
}) => {
  return {
    width: '100%'
...
export const List = styled<SharedStylePropsArgT>('ul', ({
  $isDragged
}) => {
  return ({
    paddingLeft: 0,
...
export const Item = styled<SharedStylePropsArgT>('li', ({
  $isDragged,
  $isSelected,
  $theme,
  $isFocusVisible
...
export const DragHandle = styled<SharedStylePropsArgT>('div', ({
  $theme
}) => {
...
export const CloseHandle = styled<SharedStylePropsArgT>('button', ({
  $theme,
  $isFocusVisible
}) => {
...
export const Label = styled<SharedStylePropsArgT>('div', ({
  $theme
}) => ({
  flexGrow: 1,
