...
type ChildrenT = Array<React.Node>; // Props shared by all flavors of component
...
export type StatefulComponentContainerPropsT = $Diff<StatefulListPropsT, {
  children: ChildrenT
}> & {
  initialState?: StateT,
  children: (props: $Diff<ListPropsT, {
    children: ChildrenT
  }>) => React.Node,
};
