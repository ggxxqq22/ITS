...
export const StyledList = styled<StyledPropsT>('ul', ({
  $theme,
  $isFocusVisible
}) => {
  return {
...
export const StyledListItemProfile = styled<StyledPropsT>('li', ({
  $theme
}) => ({
  position: 'relative',
  display: 'flex',
...
export const StyledProfileLabelsContainer = styled<StyledPropsT>('div', ({
  $theme
}) => ({
...
export const StyledProfileTitle = styled<StyledPropsT>('h6', ({
  $theme
...
export const StyledProfileSubtitle = styled<StyledPropsT>('p', ({
  $theme
...
export const StyledProfileBody = styled<StyledPropsT>('p', ({
  $theme
