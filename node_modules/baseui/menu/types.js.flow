...
export type GetProfileItemImgFnT = (item: ItemT) => string | React.ComponentType<*>;
...
export type StateReducerFnT = (changeType: ?$Keys<typeof STATE_CHANGE_TYPES>, changes: StatefulContainerStateT, currentState: StatefulContainerStateT) => StatefulContainerStateT;
