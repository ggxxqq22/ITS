...
import type { StatefulContainerPropsT, StatefulContainerStateT, GetRequiredItemPropsFnT, RenderPropsT, StateReducerFnT } from './types.js';
export default class MenuStatefulContainer extends React.Component<StatefulContainerPropsT, StatefulContainerStateT> {
  constructor(...args) {
    ...
    _defineProperty(this, "onKeyDown", (event: KeyboardEvent) => {
      switch (event.key) {
    ...
    _defineProperty(this, "handleArrowKey", (event: KeyboardEvent) => {
    ...
    _defineProperty(this, "handleEnterKey", (event: KeyboardEvent) => {
      const {
        onItemSelect
      } = this.props;
      const {
    ...
    _defineProperty(this, "handleItemClick", (activedescendantId: ?string, index: number, item: *, event: SyntheticMouseEvent<HTMLElement>) => {
    ...
    _defineProperty(this, "handleMouseEnter", (activedescendantId: ?string, index: number) => {
    ...
    _defineProperty(this, "focusMenu", (event: FocusEvent | MouseEvent | KeyboardEvent) => {
      const rootRef = this.props.rootRef ? this.props.rootRef : this.rootRef;
  ...
  internalSetState(changeType: $Keys<typeof STATE_CHANGE_TYPES>, changes: $Shape<StatefulContainerStateT>) {
    const {
      stateReducer
    } = this.props;
