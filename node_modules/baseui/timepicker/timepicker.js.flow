 ...
 */
function stringToOptions(str: string, format: '12' | '24' = '12'): Array<OptionT> {
...
class TimePicker extends React.Component<TimePickerPropsT, TimePickerStateT> {
  constructor(...args) {
    ...
    _defineProperty(this, "onChange", (params: OnChangeParamsT) => {
      ...
      const seconds: number = typeof params.value[0].id === 'string' ? parseInt(params.value[0].id, 10) : params.value[0].id || 0;
      this.handleChange(seconds);
    });
    _defineProperty(this, "handleChange", (seconds: number) => {
